...
<head>
    ...
    <title>Ipasme - estadisticas</title>
    <link rel="stylesheet" href="<?php echo base_url('./assets/css/bootstrap.min.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('./assets/css/bootstrap-theme.min.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('./assets/css/font-awesome.min.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('./assets/css/font-awesome.min.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('./assets/css/highcharts.min.css') ?>">
    <link rel="stylesheet" href="<?php echo base_url('./assets/css/grid-light.min.css') ?>">
</head>
<body>
    <!--Navbar bootstrap  -->
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" style="padding-top: 0;" href="<?php echo base_url('Principal'); ?>"><img id="img_logo" src="<?php echo base_url('./assets/images/logo.png') ?>" alt="Logo" title="Principal"></a>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 thumbnail">
                <p>Selecciona los rangos de fechas</p>
                <div class="col-md-4">
                    <input class="form-control" id="fecha_1" type="date">
                </div>
                <div class="col-md-4">
                    <input class="form-control" id="fecha_2" type="date">
                </div>
    ...
    <script src="<?php echo base_url('./assets/js/grid-light.js') ?>"></script>
